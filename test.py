...
significant_movement_threshold = 0.7  # Threshold for significant movement
grouping_threshold = 20  # Number of frames to consider movements as part of the same event
